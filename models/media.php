<?php
	...
	function updateRow($con) {
		...
		$uploaddir = '../media/images/project'.$project_id.'/'.$folder.'/'.$id.'/';
		$uniqid = explode('.', end( explode('/', $row['file_path']) ) )[0];
