...
<body ng-app='mbira'>
    ...
    <!--HEADER-->
        ...
        <div class="back"><a ui-sref="projects"><img src="app/assets/images/back.png"/><p>ALL PROJECTS</p></a></div>
        <div class="title"><h1>{{project.name}}</h1></div>
        <div class="info"><a  ui-sref="projectInfo({project: project.id, pid: pid})"><img src="app/assets/images/info.png"/></a></div></div>
    ...
    <div class="exhibits">
        ...
        <div class="exhibit_new"> 
            <a ui-sref="newExhibit({project: project.id, pid: pid})">
                <img src="app/assets/images/project_new_plus_icon_small.png" height="135.5" width="135.5">
